# Generated by Django 2.1.5 on 2019-02-02 10:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ingredient', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='order_management.Ingredient')),
                ('recipe', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='order_management.Recipe')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='recipe',
            name='ingredients',
            field=models.ManyToManyField(through='order_management.RecipeIngredients', to='order_management.Ingredient'),
        ),
        migrations.AddField(
            model_name='recipe',
            name='item',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='order_management.Item'),
        ),
        migrations.AddField(
